...
public class GameBackground extends GameObject {
    ...
    public GameBackground(PolygonGame game) {
        ...
        // make the background image the entire window size so it can cover the whole
        // background
    ...
    // draw the grid of hexagons across the entire background, can be adjusted for a
    // more or less dense background
    public void drawGrid() {
        // the distance between the centers of two adjacent hexagons is equal to the
        // size of the hexagon multiplied by the square root of 3, can be adjusted for a
        // more or less dense background
        double verticalDistance = (polygonSize * Math.sqrt(3) / 2); // vertical distance between hexagons, can be
                                                                    // adjusted for a more or less dense background, the
                                                                    // -1 is to account for rounding issues with hexagon
                                                                    // drawing
        double rowCount = 0;
